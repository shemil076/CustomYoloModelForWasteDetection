...
results = model.train(data='/kaggle/working/CustomYoloModelForWasteDetection/ultralytics/cfg/datasets/datasetcust.yaml', epochs=100, imgsz=640, batch=32, lr0=0.005, lrf=0.65)
